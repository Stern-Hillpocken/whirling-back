...
public abstract class RECIPES {
    public static final List<Recipe> all = new ArrayList<>(Arrays.asList(
            new Recipe(List.of(Arcanas.BOOK), List.of(Ingredients.UG), Directions.BOTH, List.of(Ingredients.R, Ingredients.R)),
            ...
            new Recipe(List.of(Arcanas.CAULDRON), List.of(Ingredients.RG), Directions.ONE, List.of(Ingredients.UG, Ingredients.G)),
            new Recipe(List.of(Arcanas.BOOK, Arcanas.BOOK), List.of(Ingredients.R, Ingredients.R, Ingredients.UG, Ingredients.UG), Directions.ONE, List.of(Ingredients.B)),
            ...
            new Recipe(List.of(Arcanas.BOOK), List.of(Ingredients.UG), Directions.ONE, List.of(Ingredients.RU, Ingredients.U)),
            ...
            new Recipe(List.of(Arcanas.BOOK, Arcanas.CAULDRON), List.of(Ingredients.W, Ingredients.R), Directions.ONE, List.of(Ingredients.W, Ingredients.UG)),
